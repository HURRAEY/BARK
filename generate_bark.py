...
SPEAKER_PRESETS = {
    ...
    "김환석": "v2/ko_speaker_3", # 남성, 중립
    "송치호": "v2/ko_speaker_7", # 남성, 낮고 침착
}
...
def emotion_tag(speaker: str, line: str) -> str:
    ...
    # 감정 판단 규칙
    if "?" in line:
        emotion = "[curious]" if speaker == "현정" else "[confused]"
    elif "!" in line:
        emotion = "[excited]"
    else:
        default = {
...
def main() -> None:
    ...
    output_path = "script_output_long.wav"
